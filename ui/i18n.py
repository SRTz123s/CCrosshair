...
STRINGS = {
    'ru': {
        ...
        'settings.autostart.desc': 'Запускать программу при включении '
                                   'компьютера',
        ...
        'tray.hide': 'Скрыть',
        'tray.quit': 'Выйти',
        'tray.minimized': 'Программа свёрнута в трей',
        'tray.close.title': 'Закрыть программу?',
        'tray.close.desc': 'Свернуть приложение в трей или полностью '
                           'выйти из него?',
        'tray.minimize': 'Свернуть в трей',
    ...
    'en': {
        ...
        'settings.autostart.desc': 'Run the program when Windows starts',
        ...
        'tray.hide': 'Hide',
        'tray.quit': 'Quit',
        'tray.minimized': 'The program is minimized to the tray',
        'tray.close.title': 'Close the program?',
        'tray.close.desc': 'Minimize to the tray or exit completely?',
